...
public class ScreenConfig {
    ...
    private Map<String, String> sharedState = new LinkedHashMap<>();
    ...
    public Map<String, String> getSharedState() { return sharedState; }
    public void setSharedState(Map<String, String> sharedState) { this.sharedState = sharedState; }
}